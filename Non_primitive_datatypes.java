...
public class Non_primitive_datatypes {
	...
	public static void main(String[] args) {
		//1) Array
	// Array is the collecton of datadypes
		//Array is the lenear and homogeneous: when you have to assign the lenght then data assigned side by side or adjusent
		//lenght count start from the 0
		// 5 : length is five but count start with 0
		//variable.length: .length give the length of an array
		//null value accssed in all non primitive datatypes
		...
		//string is not perforn mathematical operations
		*/
	...
	/*	int [] anand=new int [5];
		...
		System.out.println("anand salary is"+anand[0]);
			...
			*/
		String SBPCOE="ajhjlkfhlrfhrfjbfjdkljfefblfjkfbrbrbej";
		System.out.println(SBPCOE.length());
